...
C {tg.sym} -110 90 2 0 {name=x3}
C {tg.sym} 480 -100 0 0 {name=x4}
C {tg.sym} 540 -30 3 0 {name=x5}
C {inverter.sym} 190 -90 0 0 {name=x2}
...
C {devices/lab_wire.sym} 310 -120 0 0 {name=p7 sig_type=std_logic lab=CLK}
...
C {inverter.sym} 750 -90 0 0 {name=x6}
...
C {inverter.sym} 630 130 2 0 {name=x7}
...
C {inverter.sym} 120 80 2 0 {name=x8}
...
C {inverter.sym} 340 -360 0 0 {name=x9}
...
C {devices/lab_wire.sym} -230 -120 0 0 {name=p24 sig_type=std_logic lab=CLKB}
C {devices/lab_wire.sym} 60 110 0 0 {name=p25 sig_type=std_logic lab=CLK}
C {devices/lab_wire.sym} 520 150 0 0 {name=p26 sig_type=std_logic lab=CLKB}
