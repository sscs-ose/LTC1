...
value=3.3}
C {devices/vsource.sym} -50 -190 0 0 {name=V11 value="pwl(0 3.3 6.5US 3.3 6.50001US 0)"}
C {devices/lab_wire.sym} -50 -240 0 0 {name=p42 sig_type=std_logic lab=S4
value=3.3}
C {devices/lab_wire.sym} -50 -140 0 0 {name=p43 sig_type=std_logic lab=VSS
value=3.3}
...
C {pex_PLL_TOP_MUX_6.sym} -10 -920 0 0 {name=x1}
