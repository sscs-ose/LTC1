...
logy=0
hilight_wave=0}
T {PINS D16 DIV_OUT2 D27G D26G D17G D16G 
are deleted and connected to ground inside schematic
} -970 -630 0 0 0.4 0.4 {}
N -700 -80 -700 -50 {
lab=GND}
N -700 -170 -700 -140 {
...
C {devices/vsource.sym} -850 -390 0 0 {name=V6 value="pulse(0 3.3 0 100p 100p 50n 100n)"}
...
C {devices/lab_wire.sym} -920 -770 0 0 {name=p22 sig_type=std_logic lab=VSS}
...
C {devices/launcher.sym} 740 -500 0 0 {name=h5
descr="load waves" 
tclcommand="xschem raw_read $netlist_dir/TB_TOP_MUX_F7_sch.raw tran"
}
C {devices/gnd.sym} -260 -630 1 0 {name=l2 lab=GND}
C {devices/gnd.sym} -240 -610 1 0 {name=l3 lab=GND}
C {PLL_FINAL_SCH.sym} -10 -920 0 0 {name=x1}
C {devices/title.sym} -2720 0 0 0 {name=l4 author="ATIF KHAN"}
