...
C {devices/lab_wire.sym} -210 -610 0 0 {name=p105 sig_type=std_logic lab=D26G}
C {devices/lab_wire.sym} -200 -590 0 0 {name=p106 sig_type=std_logic lab=D27G}
C {devices/lab_wire.sym} -200 -570 0 0 {name=p107 sig_type=std_logic lab=D17G}
C {devices/lab_wire.sym} -200 -550 0 0 {name=p108 sig_type=std_logic lab=D16G}
...
C {pex_PLL_TOP_MUX_4.sym} -10 -910 0 0 {name=x1}
