...
C {devices/iopin.sym} -170 -80 0 0 {name=p6 lab=VCM_1.6}
...
L=3.9e-6}
C {devices/lab_pin.sym} 80 390 2 0 {name=p2 sig_type=std_logic lab=VSS
L=3.9e-6}
C {devices/lab_pin.sym} 60 100 0 0 {name=p3 sig_type=std_logic lab=VDD
L=3.9e-6}
C {devices/lab_pin.sym} 80 180 2 0 {name=p7 sig_type=std_logic lab=VCM_1.6
L=3.9e-6}
C {symbols/ppolyf_u.sym} 80 340 0 0 {name=R8
W=1e-6
L=7e-6
model=ppolyf_u
spiceprefix=X
