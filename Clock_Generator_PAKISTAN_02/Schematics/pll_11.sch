...
lab=PU}
N 1050 -1790 1050 -1770 {
lab=VSS}
N 850 -1810 850 -1800 {
lab=VSS}
N 1050 -1880 1070 -1880 {
lab=Vref}
...
lab=T0}
N 1820 -1500 1820 -1490 {
lab=VSS}
N 1820 -1580 1820 -1560 {
lab=vcntl_test}
N 1490 -1390 1490 -1380 {
lab=VSS}
N 1490 -1470 1490 -1450 {
lab=Vo_test}
N 2000 -1490 2000 -1480 {
lab=VSS}
N 2000 -1570 2000 -1550 {
lab=Vdiv_test}
N 1270 -1500 1270 -1490 {
lab=VSS}
N 1270 -1580 1270 -1560 {
lab=PU_test}
N 1550 -1500 1550 -1490 {
lab=VSS}
N 1550 -1580 1550 -1560 {
lab=PD_test}
...
C {devices/vsource.sym} 1050 -1820 0 0 {name=VCNTL value="pulse(3.3 0 0 100p 100p 250n 500n)"}
C {devices/vsource.sym} 850 -1840 0 0 {name=V3 value=" PWL( 0 0 100n 0 100.001n 3.3)"}
...
C {devices/lab_pin.sym} 870 -1880 2 0 {name=p16 sig_type=std_logic lab=VDD_VCO}
C {devices/lab_pin.sym} 1060 -1880 2 0 {name=p17 sig_type=std_logic lab=Vref
}
C {devices/lab_wire.sym} 640 -1800 0 0 {name=p18 sig_type=std_logic lab=VSS
}
C {devices/vsource.sym} 640 -1840 0 0 {name=V6 value=" PWL( 0 0 10n 0 10.001n 3)"}
...
C {devices/lab_pin.sym} 640 -1880 2 0 {name=p38 sig_type=std_logic lab=RST_DIV}
...
"}
C {devices/lab_wire.sym} 850 -1800 2 0 {name=p5 sig_type=std_logic lab=VSS
}
C {devices/lab_wire.sym} 1050 -1770 2 0 {name=p6 sig_type=std_logic lab=VSS
}
...
C {devices/lab_wire.sym} 1820 -1490 0 0 {name=p120 sig_type=std_logic lab=VSS
}
C {devices/vsource.sym} 1820 -1530 0 0 {name=V21 value=1.08}
C {devices/lab_pin.sym} 1820 -1570 2 0 {name=p121 sig_type=std_logic lab=vcntl_test}
C {devices/lab_wire.sym} 1490 -1380 0 0 {name=p124 sig_type=std_logic lab=VSS
}
C {devices/vsource.sym} 1490 -1420 0 0 {name=V23 value=" PWL( 0 0 10n 0 10.001n 3)"}
C {devices/lab_pin.sym} 1490 -1460 2 0 {name=p125 sig_type=std_logic lab=Vo_test}
C {devices/vsource.sym} 2000 -1520 0 0 {name=V24 value="pulse(3.3 0 20n 100p 100p 50n 100n)"}
C {devices/lab_wire.sym} 2000 -1570 0 0 {name=p126 sig_type=std_logic lab=Vdiv_test}
C {devices/lab_wire.sym} 2000 -1480 0 0 {name=p127 sig_type=std_logic lab=VSS}
C {devices/vsource.sym} 1270 -1530 0 0 {name=V22 value="pulse(3.3 0 50n 100p 100p 75n 100n)"}
C {devices/lab_wire.sym} 1270 -1580 0 0 {name=p122 sig_type=std_logic lab=PU_test}
C {devices/lab_wire.sym} 1270 -1490 0 0 {name=p123 sig_type=std_logic lab=VSS}
C {devices/vsource.sym} 1550 -1530 0 0 {name=V25 value="pulse(3.3 0 0 100p 100p 75n 100n)"}
C {devices/lab_wire.sym} 1550 -1580 0 0 {name=p128 sig_type=std_logic lab=PD_test}
C {devices/lab_wire.sym} 1550 -1490 0 0 {name=p129 sig_type=std_logic lab=VSS}
C {Prescaler_Divider.sym} 470 -1010 2 1 {name=x1}
