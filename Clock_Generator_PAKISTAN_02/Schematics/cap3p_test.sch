...
C {devices/lab_pin.sym} 250 -530 0 1 {name=l3 sig_type=std_logic lab=Pp}
C {devices/gnd.sym} 380 -330 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} 380 -370 0 0 {name=V2 value=0}
C {devices/lab_pin.sym} 380 -410 0 1 {name=l4 sig_type=std_logic lab=Nn}
C {devices/lab_pin.sym} 250 -350 0 1 {name=l2 sig_type=std_logic lab=Nn}
C {cap3p.sym} 190 -350 0 0 {name=x1}
