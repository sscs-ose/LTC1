...
C {devices/lab_pin.sym} 760 -820 2 1 {name=p17 sig_type=std_logic lab=IN1B}
C {devices/lab_pin.sym} 760 -840 2 1 {name=p18 sig_type=std_logic lab=IN2B}
C {devices/lab_pin.sym} 770 -190 0 0 {name=p19 sig_type=std_logic lab=IN1}
C {devices/lab_pin.sym} 770 -210 0 0 {name=p20 sig_type=std_logic lab=IN2}
C {devices/lab_pin.sym} 760 -610 0 0 {name=p21 sig_type=std_logic lab=IN1}
C {devices/lab_pin.sym} 760 -630 2 1 {name=p22 sig_type=std_logic lab=IN2B}
C {devices/lab_pin.sym} 760 -410 2 1 {name=p23 sig_type=std_logic lab=IN1B}
C {devices/lab_pin.sym} 760 -430 0 0 {name=p24 sig_type=std_logic lab=IN2}
