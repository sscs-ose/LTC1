...
C {devices/vsource.sym} 650 -960 0 0 {name=V7 value=3.3}
C {devices/lab_wire.sym} 650 -920 0 0 {name=p26 sig_type=std_logic lab=VSS
}
C {devices/lab_wire.sym} 650 -1010 0 0 {name=p27 sig_type=std_logic lab=F1}
C {devices/vsource.sym} 510 -980 0 0 {name=V8 value=3.3}
C {devices/lab_wire.sym} 510 -940 0 0 {name=p25 sig_type=std_logic lab=VSS
}
C {devices/lab_wire.sym} 510 -1030 0 0 {name=p29 sig_type=std_logic lab=F0}
C {devices/vsource.sym} 750 -960 0 0 {name=V9 value=3.3}
C {devices/lab_wire.sym} 750 -920 0 0 {name=p30 sig_type=std_logic lab=VSS
}
C {devices/lab_wire.sym} 750 -1010 0 0 {name=p31 sig_type=std_logic lab=F2}
...
C {pll_2_top.sym} 630 -440 0 0 {name=x1}
C {devices/lab_pin.sym} 450 -530 0 0 {name=p1 sig_type=std_logic lab=Vref
}
C {devices/lab_pin.sym} 450 -510 0 0 {name=p2 sig_type=std_logic lab=EN}
C {devices/lab_pin.sym} 450 -490 0 0 {name=p3 sig_type=std_logic lab=RST_DIV}
...
C {devices/vsource.sym} 280 -490 0 0 {name=V20 value=3.3}
C {devices/lab_wire.sym} 280 -450 0 0 {name=p22 sig_type=std_logic lab=VSS
}
C {devices/lab_wire.sym} 280 -540 0 0 {name=p23 sig_type=std_logic lab=PU_test}
