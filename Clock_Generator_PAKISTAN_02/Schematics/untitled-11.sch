...
C {devices/lab_wire.sym} 150 -620 0 0 {name=p11 sig_type=std_logic lab=P1}
...
C {devices/lab_wire.sym} 150 -500 0 0 {name=p18 sig_type=std_logic lab=P0}
C {devices/lab_wire.sym} 150 -410 0 0 {name=p19 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} 400 -650 0 0 {name=p20 sig_type=std_logic lab=P1}
C {devices/lab_wire.sym} 400 -630 0 0 {name=p21 sig_type=std_logic lab=P0}
C {pex_Output_Divider_Mag.sym} 570 -640 0 0 {name=x1}
