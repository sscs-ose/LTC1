...
C {devices/vsource.sym} -980 730 0 0 {name=V3 value=1.6}
...
C {devices/vsource.sym} -1370 690 0 0 {name=V4 value="0 AC 1u 180"}
C {devices/vsource.sym} -1440 730 0 0 {name=V5 value="0 AC 1u"}
...
C {devices/isource.sym} -860 730 0 0 {name=I0 value=20u}
C {devices/lab_wire.sym} -860 680 0 0 {name=p31 sig_type=std_logic lab=IREF}
C {devices/code_shown.sym} -520 870 0 0 {name=MODELS only_toplevel=true
format="tcleval( @value )"
value="
.include $::180MCU_MODELS/design.ngspice
.lib $::180MCU_MODELS/sm141064.ngspice typical
"}
C {devices/code_shown.sym} -450 -170 0 0 {name=NGSPICE only_toplevel=true
value="
.control
set color0=white
set color1=black
...
.endc
"}
C {devices/vsource.sym} -1060 980 0 0 {name=V6 value="3.3"}
C {devices/gnd.sym} -1060 1040 0 0 {name=l6 lab=GND}
C {devices/vsource.sym} -1210 1080 0 0 {name=V7 value="3.3"}
C {devices/gnd.sym} -1210 1140 0 0 {name=l7 lab=GND}
C {devices/vsource.sym} -1130 1020 0 0 {name=V8 value="3.3"}
C {devices/gnd.sym} -1130 1080 0 0 {name=l8 lab=GND}
C {devices/lab_wire.sym} -860 790 0 0 {name=p32 sig_type=std_logic lab=VSS}
C {devices/lab_wire.sym} -1210 1030 0 0 {name=p55 sig_type=std_logic lab=C}
C {devices/lab_wire.sym} -1130 970 0 0 {name=p56 sig_type=std_logic lab=B}
C {devices/lab_wire.sym} -1060 920 0 0 {name=p57 sig_type=std_logic lab=A}
...
C {/home/shahid/GF180Projects/GF_INV/Xschem/Tapeout/PGA_Block/PGA_block.sym} -900 380 0 0 {name=x1}
