...
N -50 -110 -20 -110 {
lab=OUTo}
C {devices/code_shown.sym} -490 370 0 0 {name=MODELS only_toplevel=true
...
C {devices/res.sym} -410 -340 1 0 {name=R6
value=800
footprint=1206
device=resistor
m=1}
C {devices/lab_wire.sym} -200 -340 0 1 {name=p62 sig_type=std_logic lab=OUTo
}
C {devices/capa.sym} -260 -340 3 0 {name=C2
m=1
value=1.5p
footprint=1206
device="ceramic capacitor"}
C {devices/lab_wire.sym} -290 -10 1 1 {name=p22 sig_type=std_logic lab=VBIASN}
C {devices/lab_wire.sym} -450 -310 0 0 {name=p13 sig_type=std_logic lab=OUT
}
